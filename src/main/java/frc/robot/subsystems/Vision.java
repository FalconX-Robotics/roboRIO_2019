...
//             // double[][] rectLeft = organize(doubleArrayOne), rectRight =
//             // organize(doubleArrayTwo);

//             // // find rect side
//             // // average x value of rect 1 is more rect 2 then rect 1 is right
//             // if (average(getDimensionArray(rectLeft, 0)) >
//             // average(getDimensionArray(rectRight, 0))) {
...
//             // double rectangleLeft = findDistanceToCamera(knownHeight, focalLength,
//             // perLeftHeight);

//             // double perRightHeight = getPerWidth(rectRight);
//             // double rectangleRight = findDistanceToCamera(knownHeight, focalLength,
//             // perRightHeight);
//             SmartDashboard.putString("Length of rectangles", "One: " + rectangleOneAngles.getDoubleArray().length
//                     + " Two: " + rectangleTwoValue.getDoubleArray().length);
